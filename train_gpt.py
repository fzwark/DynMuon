...
class Hyperparameters:
    ...
    # data_dir: str = "data/finewebedu10B"
...
def init_optimizer(
    ...
    param_groups.append(
        dict(
            ...
            lr=hp.scalar_lr,  # no LR adjustment for embedding parameters
            betas=(0.9, 0.95),
    ...
    param_groups.append(
        dict(
            ...
            algorithm=hp.scalar_opt,
            lr=hp.scalar_lr,  # scale LR for lm_head
            betas=(0.9, 0.95),
...
def main():
    ...
    run_name += f"_{hp.n_layer}_{hp.model_dim}_{hp.n_layer}_{hp.n_head}_{hp.lr}"
