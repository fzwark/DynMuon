...
class GPT(nn.Module):
    ...
    def tie_weights(self):
        # share the exact same Parameter object
    ...
    def forward(self, idx, targets=None, return_logits=False,return_hidden=False, hidden_layer_idx=-1):
        x = self._forward_emb(idx)
        return self._forward(x, targets, return_logits, return_hidden=return_hidden, hidden_layer_idx=hidden_layer_idx)
    ...
    def forward(self, idx, targets=None, return_logits=False,
        ...
        if use_compiled:
            ...
            # if not compiled yet, self._forward_emb exists as eager anyway
